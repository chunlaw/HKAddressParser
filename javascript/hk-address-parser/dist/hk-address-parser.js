(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@turf/turf'), require('proj4'), require('stream'), require('http'), require('url'), require('https'), require('zlib')) :
  typeof define === 'function' && define.amd ? define(['@turf/turf', 'proj4', 'stream', 'http', 'url', 'https', 'zlib'], factory) :
  (global = global || self, global['hk-address-parser'] = factory(global.turf, global.proj4, global.Stream, global.http, global.Url, global.https, global.zlib));
}(this, function (turf, proj4, Stream, http, Url, https, zlib) { 'use strict';
